    ...
    const exampleLEData: LayoutData = {
      ...
      content: {
        ...
        expansions: [
          ...
          {
            // 3. hints: 최하/하/중 2개씩, lemma에 <>
            type: 'hints',
            content: [
              'Люди <умирают> когда они старые.',
              'Когда человек <умирает>, он не живёт.',
              'Люди <умирают>, когда они очень больны или происходит что-то плохое.',
              'Все люди когда-нибудь <умирают>, это часть жизни.',
              'Люди <умирают> по разным причинам: болезнь, возраст или несчастный случай.',
              'Когда организм больше не может работать нормально, человек <умирает>.'
            ]
          }
        ]
      }
